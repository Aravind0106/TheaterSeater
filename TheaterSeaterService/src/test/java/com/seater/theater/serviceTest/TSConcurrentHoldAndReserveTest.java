...
public class TSConcurrentHoldAndReserveTest implements Runnable{
	...
	public void concurrentTest() throws InterruptedException{
        ...
        for (int i = 0; i < 10; i++) {
            Runnable worker = new TSConcurrentHoldAndReserveTest();
	...
	public void run() {
		...
		try {
			...
			seatsHeld = ticketService.findAndHoldSeats(10, 1, 2, "aravind0106@gmail.com");
			assertEquals(seatsHeld.getSeatsHeld().size(), 10);
